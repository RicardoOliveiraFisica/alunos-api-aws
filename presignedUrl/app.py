...
def lambda_handler(event, context):
    ...
    # https://zarbulz6r6.execute-api.us-east-2.amazonaws.com/Prod/presigned-url?fileName=arquivo.txt&contentType=text/plain
    ...
    expiration_time = 60 # Tempo de expiração do link gerado em segundos
